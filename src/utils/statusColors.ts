...
export const getModernStatusStyle = (status: string): string => {
  const modernStyles: Record<string, string> = {
    ...
    'Planejamento gerado': 'bg-gradient-to-r from-green-700/30 to-green-800/30 text-green-100 border border-green-700/40 shadow-lg shadow-green-700/20',
    'Planj/Gerado': 'bg-gradient-to-r from-green-600/30 to-green-700/30 text-green-100 border border-green-600/40 shadow-lg shadow-green-600/20',
...
export const getStatusBadgeClasses = (status: string): string => {
  const badgeStyles: Record<string, string> = {
    ...
    'Planejamento gerado': 'bg-green-700 text-white hover:bg-green-800',
    'Planj/Gerado': 'bg-green-600 text-white hover:bg-green-700',
