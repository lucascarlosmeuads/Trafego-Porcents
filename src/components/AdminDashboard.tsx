      ...
      case 'sites':
        return (
          <div className="space-y-4">
            ...
            <AdminTable selectedManager={selectedManager} filterType="sites-pendentes" />
          </div>
        )
      ...
      case 'saques-pendentes':
        return (
          <div className="space-y-4">
            ...
            <AdminTable selectedManager={selectedManager} filterType="saques-pendentes" />
          </div>
        )
