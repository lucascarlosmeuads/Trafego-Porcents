...
export function AdicionarClienteAdminModal({ onClienteAdicionado }: AdicionarClienteAdminModalProps) {
  ...
  const [clienteAdicionado, setClienteAdicionado] = useState<{email: string, nome: string} | null>(null)
...
Qualquer dúvida, entre em contato conosco!`
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Salvar dados do cliente para o modal de instruções
    ...
    <>
      ...
      {clienteAdicionado && (
        <ClientInstructionsModal
          ...
          clientEmail={clienteAdicionado.email}
          clientName={clienteAdicionado.nome}
        />
      )}
    </>
  )
