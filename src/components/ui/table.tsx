...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-x-scroll scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200">
    <table
      ref={ref}
      className={cn("w-full caption-bottom text-sm min-w-[1400px]", className)}
      {...props}
    />
  </div>
))
