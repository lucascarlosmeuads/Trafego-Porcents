...
export function MensagemInstitucional() {
  ...
  // 🎯 NOVA LÓGICA: Se os termos já foram aceitos, não mostrar nada
  // (independente se é cliente antigo ou novo)
  if (termosAceitos) {
    return null
  }
  ...
  // Interface específica para clientes antigos que ainda não interagiram com os termos
  if (clienteAntigo) {
    return (
      <>
  ...
  // Interface para clientes novos que ainda NÃO aceitaram os termos
  return (
    <>
      <Card className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border-blue-500/30 shadow-lg">
        <CardContent className="p-6">
            ...
            <div className="bg-gray-800/50 border border-gray-600 rounded-lg p-4">
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="default"
                  size="lg"
                  className="bg-teal-600 hover:bg-teal-700 text-white font-semibold px-6 animate-pulse"
                >
