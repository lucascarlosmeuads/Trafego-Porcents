...
export default function Termos() {
  ...
  const handleRejeitarTermos = async () => {
    ...
    try {
      ...
      // Navegar de volta para o dashboard (que vai mostrar a tela de rejeição)
      navigate('/')
    } catch (error: any) {
      console.error('❌ [Termos] Erro crítico:', error)
      toast({
    ...
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      <div className="bg-gray-900 border-b border-gray-700 px-4 py-4">
        <div className="max-w-4xl mx-auto flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-xl font-bold">Termos de Uso e Condições Gerais</h1>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto p-4">
        <ScrollArea className="h-[calc(100vh-200px)]">
          <div className="space-y-6 text-gray-300 pr-4">
            ...
            {/* Espaçamento extra para evitar sobreposição com botões fixos */}
            <div className="h-20" />
          </div>
        </ScrollArea>
      </div>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-gray-900 border-t border-gray-700 p-4">
        <div className="max-w-4xl mx-auto">
          {/* Se já aceitou os termos, mostrar apenas botão de voltar */}
          {termosAceitos ? (
            <Button
              onClick={handleVoltar}
              size="lg"
