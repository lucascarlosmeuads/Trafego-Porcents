...
export default function Termos() {
  ...
  const handleAceitarTermos = async () => {
    ...
    try {
      console.log('🔄 [Termos] Salvando aceitação dos termos para:', user.email)
      ...
      if (error) {
        console.error('❌ [Termos] Erro ao salvar aceitação:', error)
        throw error
      }

      console.log('✅ [Termos] Termos aceitos com sucesso!')
      ...
      console.error('❌ [Termos] Erro crítico:', error)
      toast({
        title: "Erro",
  ...
  const handleRejeitarTermos = async () => {
    ...
    try {
      console.log('🔄 [Termos] Salvando rejeição dos termos para:', user.email)
      ...
      if (error) {
        console.error('❌ [Termos] Erro ao salvar rejeição:', error)
        throw error
      }

      console.log('❌ [Termos] Termos rejeitados com sucesso!')
            ...
            <div className="space-y-8 text-gray-300">
              ...
              <div className="bg-teal-900/20 border border-teal-500/30 rounded-lg p-6">
                <div className="flex items-start gap-4">
                  <AlertTriangle className="h-6 w-6 text-teal-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-teal-300 mb-3 text-lg">Modelo de Parceria</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-4">1. OBJETO DOS SERVIÇOS</h3>
                <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-4">2. TAXA DE ATIVAÇÃO E ESTRUTURA INICIAL</h3>
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-4">3. MODELO POR PORCENTAGEM</h3>
                <div className="space-y-4">
                  <p className="leading-relaxed">
              ...
              <div className="bg-orange-900/20 border border-orange-500/30 rounded-lg p-6">
                <h3 className="text-xl font-semibold text-orange-300 mb-4">4. CONTINUIDADE DA PARCERIA</h3>
                <div className="space-y-4">
                  <p className="leading-relaxed">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-4">5. RESPONSABILIDADES</h3>
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-semibold text-teal-400 mb-3">Responsabilidades do Cliente:</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-teal-400 mb-3">Responsabilidades da Tráfego Porcents:</h4>
                    <ul className="space-y-2 text-sm">
              ...
              <div>
                <h3 className="text-xl font-semibold text-white mb-4">6. POLÍTICA DE REEMBOLSO</h3>
                <div className="space-y-4">
                  <p className="leading-relaxed">
            ...
            <div className="mt-12 pt-6 border-t border-gray-700">
              {termosAceitos ? (
                <Button
                  onClick={() => navigate('/')}
                  size="lg"
                  className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-4"
                >
                  Voltar ao Dashboard
                </Button>
              ) : (
                <div className="flex flex-col sm:flex-row gap-4">
                  <Button
                    ...
                    variant="outline"
                    size="lg"
                    className="flex-1 border-red-500 text-red-400 hover:bg-red-500/10 py-4"
                  ...
                  <Button
                    ...
                    size="lg"
                    className="flex-1 bg-teal-600 hover:bg-teal-700 text-white font-semibold py-4"
                    disabled={aceitando || rejeitando}
                  >
